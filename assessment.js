var me={firstname: "Rachel", age: 31, state: "Washington"};// #1 Create an object called 'me' that has three keys, 'firstname' 'age' and 'state'. Assign the keys the appropriate values.
// CODE HERE
...
var adjustCount={
 ...
 var myFriends=["May", "June","Chi", "Rock"];// CODE HERE

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("Rosy"); // CODE HERE
...
var trueFriends=peopleIknow.filter(function(name,i,arr){
  if(name.friend===true){
    console.log(name);
